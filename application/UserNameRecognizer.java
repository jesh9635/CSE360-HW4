...
public class UserNameRecognizer {
		...
		while (running) {
			...
			case 1: 
				...
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for A-Z
						...
						(currentChar >= '0' && currentChar <= '9')){	// Check for a-z	// Check for 0-9
					nextState = 1;
		...
		case 1:
			...
			if (userNameSize < 4) {
				...
				userNameRecognizerErrorMessage += 
					...
					"The characters '-', '_' and '.' are allowed only in between alphanumeric characters.\n";
				return userNameRecognizerErrorMessage;
			}
			else {
					// UserName is valid
	...
	public static boolean isValid(String input) {
	    return checkForValidUserName(input).isEmpty();
	}
